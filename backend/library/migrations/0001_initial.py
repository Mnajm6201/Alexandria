    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["name"],
                "indexes": [
                    models.Index(fields=["name"], name="library_ach_name_4cadda_idx"),
                    models.Index(
                        fields=["difficulty_lvl"], name="library_ach_difficu_475097_idx"
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["name"],
                "indexes": [
                    models.Index(fields=["name"], name="library_aut_name_b2f398_idx"),
                    models.Index(
                        fields=["author_id"], name="library_aut_author__b3cfb8_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="library.BookAuthor", to="library.author"
            ),
        ),
        migrations.CreateModel(
            name="BookClub",
        ...
        migrations.AddField(
            ...
            name="users",
            field=models.ManyToManyField(
                through="library.ClubMember", to=settings.AUTH_USER_MODEL
            ),
        ),
        migrations.CreateModel(
            name="Community",
        ...
        migrations.AddField(
            ...
            name="users",
            field=models.ManyToManyField(
                through="library.CommunityUser", to=settings.AUTH_USER_MODEL
            ),
        ),
        migrations.CreateModel(
            name="Edition",
        ...
        migrations.AddField(
            ...
            name="genres",
            field=models.ManyToManyField(
                through="library.BookGenre", to="library.genre"
            ),
        ),
        migrations.CreateModel(
            name="JournalEntry",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "ordering": ["name"],
                "indexes": [
                    models.Index(fields=["name"], name="library_pub_name_d0230a_idx")
                ],
            },
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="books",
            field=models.ManyToManyField(
                through="library.ShelfEdition", to="library.edition"
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name="achievements",
            field=models.ManyToManyField(
                through="library.UserAchievement", to="library.achievement"
            ),
        ),
        migrations.CreateModel(
            name="UserBook",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["book", "author"], name="library_boo_book_id_df3dfd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="bookauthor",
            index=models.Index(
                fields=["author", "book"], name="library_boo_author__f70c84_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="announcement",
            index=models.Index(
                fields=["created_on"], name="library_ann_created_eb03df_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="announcement",
            index=models.Index(
                fields=["is_pinned"], name="library_ann_is_pinn_e9b130_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="bookclubhistory",
            index=models.Index(
                fields=["club", "book"], name="library_boo_club_id_ae4016_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="bookclubhistory",
            index=models.Index(
                fields=["end_date"], name="library_boo_end_dat_248504_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="bookclubhistory",
            constraint=models.UniqueConstraint(
                fields=("club", "book", "order"), name="unique_club_book_order"
            ),
        ),
        migrations.AddIndex(
            model_name="clubmember",
            index=models.Index(
                fields=["club", "is_admin"], name="library_clu_club_id_8696c5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="clubmember",
            index=models.Index(
                fields=["reading_status"], name="library_clu_reading_3b2b58_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="clubmember",
            constraint=models.UniqueConstraint(
                fields=("user", "club"), name="unique_club_user"
            ),
        ),
        migrations.AddIndex(
            model_name="bookclub",
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("community", "user"), name="unique_community_user"
            ),
        ),
        migrations.AddIndex(
            model_name="bookgenre",
            index=models.Index(
                fields=["book", "genre"], name="library_boo_book_id_6bd4f4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="bookgenre",
            index=models.Index(
                fields=["genre", "book"], name="library_boo_genre_i_2ad37e_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="bookgenre",
        ...
        migrations.AddIndex(
            model_name="book",
            index=models.Index(
                fields=["year_published"], name="library_boo_year_pu_152fda_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="book",
            index=models.Index(
                fields=["book_id"], name="library_boo_book_id_ea9395_idx"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name="journalentry",
            index=models.Index(
                fields=["page_num"], name="library_jou_page_nu_6cc00d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="journalentry",
            index=models.Index(
                fields=["updated_on"], name="library_jou_updated_894b6e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="journalentry",
            index=models.Index(
                fields=["is_private"], name="library_jou_is_priv_669d73_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="post",
        ...
        migrations.AddIndex(
            model_name="post",
            index=models.Index(
                fields=["like_count"], name="library_pos_like_co_7148d6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="post",
            index=models.Index(
                fields=["page_num"], name="library_pos_page_nu_4e92ea_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="post",
            constraint=models.CheckConstraint(
                condition=models.Q(
                    models.Q(("club__isnull", False), ("community__isnull", True)),
                    models.Q(("club__isnull", True), ("community__isnull", False)),
                    _connector="OR",
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["like_count"], name="library_pos_like_co_75bafd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="postcomment",
            index=models.Index(
                fields=["page_num"], name="library_pos_page_nu_de53b2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="postcomment",
            index=models.Index(
                fields=["created_on"], name="library_pos_created_bdc8b8_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="edition",
        ...
        migrations.AddIndex(
            model_name="edition",
            index=models.Index(
                fields=["publication_year"], name="library_edi_publica_9f41b7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="edition",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["club", "book"], name="library_rea_club_id_acee8d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="readingschedule",
            index=models.Index(
                fields=["is_active"], name="library_rea_is_acti_5e9626_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="readingschedule",
            index=models.Index(
                fields=["start_date"], name="library_rea_start_d_403ae2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="readingschedule",
            index=models.Index(
                fields=["end_date"], name="library_rea_end_dat_9337e4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="review",
            index=models.Index(
                fields=["created_on"], name="library_rev_created_f8b889_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="review",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["like_count"], name="library_rev_like_co_0821ee_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="reviewcomment",
            index=models.Index(
                fields=["page_num"], name="library_rev_page_nu_ecbbe1_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="reviewcomment",
            index=models.Index(
                fields=["created_on"], name="library_rev_created_e73be5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="schedulemilestone",
            index=models.Index(
                fields=["schedule"], name="library_sch_schedul_5e0363_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="schedulemilestone",
            index=models.Index(
                fields=["target_date"], name="library_sch_target__73220e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="shelfcomment",
            index=models.Index(
                fields=["like_count"], name="library_she_like_co_44ecc3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="shelfcomment",
            index=models.Index(
                fields=["page_num"], name="library_she_page_nu_85ee47_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="shelfcomment",
            index=models.Index(
                fields=["created_on"], name="library_she_created_99de7c_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="shelfedition",
            constraint=models.UniqueConstraint(
                fields=("shelf", "edition"), name="unique_shelf_edition"
            ),
        ),
        migrations.AddIndex(
            model_name="shelf",
        ...
        migrations.AddIndex(
            model_name="shelf",
            index=models.Index(
                fields=["shelf_type"], name="library_she_shelf_t_820c12_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="userachievement",
            index=models.Index(
                fields=["completed"], name="library_use_complet_b93863_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="userachievement",
        ...
        migrations.AddIndex(
            model_name="userbook",
            index=models.Index(
                fields=["read_status"], name="library_use_read_st_acd498_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="userbook",
            index=models.Index(
                fields=["is_owned"], name="library_use_is_owne_9eae47_idx"
            ),
        ),
        migrations.AddConstraint(
            model_name="userbook",
        ...
        migrations.AddIndex(
            model_name="journal",
            index=models.Index(
                fields=["updated_on"], name="library_jou_updated_27cc67_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="journal",
            index=models.Index(
                fields=["is_private"], name="library_jou_is_priv_dbc54c_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="user",
            index=models.Index(
                fields=["username"], name="library_use_usernam_0569ae_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="user",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["zip_code"], name="library_use_zip_cod_e2100c_idx"
            ),
        ),
    ]
