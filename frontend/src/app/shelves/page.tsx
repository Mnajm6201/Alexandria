        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <motion.div 
            ...
            <button
              ...
              className="flex items-center px-4 py-2 bg-amber-700 text-white rounded-full hover:bg-amber-900"
            >
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-white rounded-lg shadow">
            ...
            <motion.div 
              ...
              <button
                onClick={() => setIsModalOpen(true)}
                className="px-4 py-2 bg-amber-700 text-white rounded-full hover:bg-amber-900"
              >
